...
def send_message(sender_id: int, recipient_id: int, message_content: str):
    ...
    # Always mark new messages as unread initially
    new_message = Message(
        uid=message_id,
        contents=message_content,
        sender_id=sender_id,
        receiver_id=recipient_id,
        has_been_read=False  # Messages are unread by default until explicitly marked as read
    )
    
    # Add to recipient's unread messages queue
    ...
    # Message has been added to unread queue above
